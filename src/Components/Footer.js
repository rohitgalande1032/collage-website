                    ...
                    <div className="row wrap">
                        ...
                        <div className="col-md-3">
                            <div className="quick-link" style={{ padding:'0px 10px 10px 15px'}}>
                                ...
                                <h3 className="quick-links " style={{ color: 'red' }}> <i className="fas fa-paperclip"></i> <strong> Quick Links </strong> </h3>
                        ...
                        <div className="col-md-3">
                            <div style={{ marginTop: '1px' }}>
                                <h3 className="quick-links " style={{ color: 'red' }}> <i className="fas fa-code-branch"></i> <strong> Explorer </strong> </h3>
